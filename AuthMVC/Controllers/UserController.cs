...
public class UserController : Controller
{
    ...
    public async Task<IActionResult> PasswordReset(ResetPasswordViewModel model)
    {
        ...
        if (user != null)
        {
            ...
            mail.From = new MailAddress("bkaraca.71m@gmail.com", "Şifre Güncelleme", System.Text.Encoding.UTF8);
            ...
            smp.Credentials = new NetworkCredential("bkaraca.71m@gmail.com", "kxrt pzyg pwfi ihtq");
            smp.Port = 587;
    ...
    async Task SetNewCookieAsync(AppUser user)
    {
        await _userManager.UpdateSecurityStampAsync(user);
        await _signInManager.SignOutAsync();
        await _signInManager.SignInAsync(user, true);
